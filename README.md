...
- Django 管理サイトから記事の追加・更新をすることができる。
- 記事の入力欄は記事タイトル、記事本文、作成日の 3 つを用意する。
- 作成日は、記事の新規作成の場合はページアクセス時の現在日付・時間が既に入力されており、記事更新の場合には既に保存された値が表示される。
- 記事本文はプレーンテキストで書くようにする。
